...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('images/branding/merotable-logo.png') }}" type="image/x-icon">
    {{-- <img class="logo h-8 w-8 object-contain" src="{{ asset('images/branding/merotable-logo.png') }}" alt="Logo"> --}}
