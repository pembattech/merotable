{{-- Mobile Topbar --}}
<div class="md:hidden fixed top-0 left-0 right-0 z-50 bg-gray-900 flex items-center justify-between px-2 py-1 shadow-lg">
    <div class="flex items-center gap-2">
        <img class="logo w-28" src="{{ asset('images/branding/merotable-logo.png') }}" alt="Logo">
        </div>
...
<aside id="sidebar"
    ...
    <div class="hidden md:block p-2">
            <img class="logo" src="{{ asset('images/branding/merotable-logo.png') }}" alt="Logo">
    </div>
